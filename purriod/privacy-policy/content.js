const legalPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Purriod may request access to the following features on your device:",
        "Purriod does not require you to create an account in order to use the app. We do not intentionally collect personal information such as your name, precise location, or contact list through the core app experience."
      ],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        "Purriod can schedule local notifications on your device for reminders and features that you choose to enable, such as cat-related reminders or app activity prompts.",
        "Notification content is generated from information stored in the app on your device. You can change notification settings or disable notifications at any time through your device settings or within the app where available."
      ]
    },
    {
      id: "import-export",
      ...
      paragraphs: [
        "Purriod may allow you to export your app data into a backup file and import that file again later."
      ],
      list: [
        "<strong>Export:</strong> Backup files are created at your request for portability or safekeeping.",
        "<strong>Import:</strong> If you import a backup file, its contents are read and restored into the app on your device.",
        "<strong>Your control:</strong> If you save or share backup files outside the app, their protection depends on where and how you store them."
      ]
    },
    {
      id: "analytics",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "This may include:",
        "Uninstalling the app may also remove locally stored app data from your device, depending on your platform and backup settings."
      ],
      list: [
        "Deleting cat photos",
